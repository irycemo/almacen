<div>
    ...
    @if(count($requests))
            ...
            <div class="rounded-lg mb-5 p-4 font-thin flex justify-between bg-white items-center">
                ...
                <p class="text-xl font-extralight">Se encontraron: {{ $requests->total() }} registros con los filtros seleccionados.</p>
            ...
            <div class="relative overflow-x-auto rounded-lg shadow-xl">
                ...
                <div class="h-full w-full rounded-lg bg-gray-200 bg-opacity-75 absolute top-0 left-0" wire:loading wire:target="requests">
