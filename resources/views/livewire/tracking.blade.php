                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <p class="bg-white rounded-full border border-gray-400 px-4 py-1">{{ $article->name }}</p>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <p class="bg-white rounded-full border border-gray-400 px-4 py-1">{{ $article->brand}}</p>
                    ...
                    @if ($article->serial)
                        ...
                        <div class="flex-auto ">
                            ...
                            <div>
                                ...
                                <p class="bg-white rounded-full border border-gray-400 px-4 py-1">{{ $article->serial }}</p>
                    ...
                    @else
                        ...
                        <div class="flex-auto ">
                            ...
                            <div>
                                ...
                                <p class="bg-white rounded-full border border-gray-400 px-4 py-1">{{ $article->stock }}</p>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <p class="bg-white capitalize rounded-full border border-gray-400 px-4 py-1">{{ $article->location }}</p>
                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <p class="bg-white capitalize rounded-full border border-gray-400 px-4 py-1">{{ $article->category->name }}</p>
                    ...
                    @if ($article->created_by)
                        ...
                        <div class="flex-auto ">
                            ...
                            <div>
                                ...
                                <p class="bg-white capitalize rounded-full border border-gray-400 px-4 py-1">{{ $article->createdBy->name }}</p>
                    ...
                    @if ($article->updated_by)
                        ...
                        <div class="flex-auto ">
                            ...
                            <div>
                                ...
                                <p class="bg-white capitalize rounded-full border border-gray-400 px-4 py-1">{{ $article->updatedBy->name }}</p>
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <Label class="text-gray-600">Origen</Label>

                        </div>

                        <div>

                            <p class="bg-white capitalize rounded-full border border-gray-400 px-4 py-1">{{ $article->origin }}</p>
                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <Label class="text-gray-600">Descripción de adquisición</Label>

                        </div>

                        <div>

                            <p class="bg-white capitalize rounded border border-gray-400 px-4 py-1">{{ $article->comment }}</p>
