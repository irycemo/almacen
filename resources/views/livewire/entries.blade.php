<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Entradas</h1>
        ...
        <div class="flex justify-between">
            ...
            @can('Crear entrada')
                ...
                <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">
                    <img wire:loading wire:target="openModalCreate" class="mx-auto h-4 mr-1" src="{{ asset('storage/img/loading3.svg') }}" alt="Loading">

                    Agregar nueva entrada
                </button>

                <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right text-sm py-2 px-4 text-white rounded-full focus:outline-none md:hidden">+</button>
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('description')" class="cursor-pointer px-1 py-3 hidden lg:table-cell">
                        ...
                        <th wire:click="order('updated_at')" class="cursor-pointer px-1 py-3 hidden lg:table-cell">
                        ...
                        <th class="px-1 py-3 hidden lg:table-cell">Acciones</th>
                ...
                <tbody class="divide-y divide-gray-200 flex-1 sm:flex-none ">
                    ...
                    @foreach($entries as $entrie)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div class="flex flex-col mb-3">
                            ...
                            <div>
                                ...
                                @error('article') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
            ...
            <div class="float-righ">
                ...
                @if($create)
                    ...
                    <button
                        ...
                        <img wire:loading wire:target="create" class="mx-auto h-4 mr-1" src="{{ asset('storage/img/loading3.svg') }}" alt="Loading">
                ...
                @if($edit)
                    ...
                    <button
                        ...
                        wire:target="update"
                        class="bg-blue-400 hover:shadow-lg text-white font-bold px-4 py-2 rounded-full text-sm mb-2 hover:bg-blue-700 flaot-left mr-1 focus:outline-none">
                        <img wire:loading wire:target="update" class="mx-auto h-4 mr-1" src="{{ asset('storage/img/loading3.svg') }}" alt="Loading">
